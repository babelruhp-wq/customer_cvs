...
class _CandidateCardState extends State<CandidateCard> {
  ...
  Future<List<int>> _loadPdf() {
    return context.read<CvCatalogCubit>().getCvPdf(widget.candidate.id);
  }
      ...
      child: AnimatedContainer(
        ...
        child: Column(
          ...
          children: [
            ...
            _CardFooter(onOpen: _openDetails),
          ],
        ),
      ),
    );
            ...
            child: FutureBuilder<List<int>>(
              ...
              builder: (context, snapshot) {
                ...
                if (snapshot.hasError || bytes == null || bytes.isEmpty) {
                  return _PdfError(onRetry: onRetry);
                }
...
class _CardFooter extends StatelessWidget {
  ...
  const _CardFooter({required this.onOpen});
    ...
    return Padding(
      ...
      child: SizedBox(
        ...
        child: FilledButton.icon(
          onPressed: onOpen,
          icon: const Icon(Icons.fullscreen_rounded, size: 21),
          label: Text(
            'عرض السيرة الذاتية',
            style: GoogleFonts.cairo(
              fontSize: 13,

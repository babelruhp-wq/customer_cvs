...
class _PassportSearchField
    extends StatefulWidget {
  final String value;

  const _PassportSearchField({
    required this.value,
  });

  @override
  State<_PassportSearchField>
  createState() =>
      _PassportSearchFieldState();
}

class _PassportSearchFieldState
    extends State<_PassportSearchField> {
  ...
  void didUpdateWidget(
      covariant _PassportSearchField
      oldWidget,
      ) {
...
class _NoCountrySelected
    extends StatelessWidget {
  final VoidCallback onBack;

  const _NoCountrySelected({
